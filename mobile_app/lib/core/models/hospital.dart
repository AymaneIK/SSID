class Hospital {
  ...
  static List<Hospital> mockHospitals() => const [
        ...
        Hospital(
          ...
          type: 'Public',
          departments: ['Cardiologie', 'Oncologie', 'Urgences', 'Chirurgie'],
          rating: 4.9,
          hasEmergency: true,
        ),
        Hospital(
          id: '6',
          name: 'CHU Ibn Rochd',
          address: 'Quartier Hopitaux, Casablanca',
          city: 'Casablanca',
          region: 'Casablanca-Settat',
          phone: '+212 522 445 566',
          type: 'Public',
          departments: ['Neurologie', 'Cardiologie', 'Urgences', 'Chirurgie'],
          rating: 4.7,
          hasEmergency: true,
        ),
        Hospital(
          ...
          type: 'Privé',
          departments: ['Pédiatrie', 'Gynécologie', 'Médecine Interne'],
          rating: 4.8,
          hasEmergency: true,
        ),
      ];
